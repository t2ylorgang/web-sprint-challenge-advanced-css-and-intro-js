...
function get20s(arr){
  ...
  for (let i=0; i < arr.length; i++) {
    let arrItem = arr[i];
    let yearsOnly = (arrItem.years.split(" - "));
    if (yearsOnly[0] > 1900 && yearsOnly[1] < 2000) {
    twentiethCenturyArtists.push(arrItem.name);
    }
  }
...
function addArtist(arr) {
    arr.push({id: 20, name: "Taylor Olson", years: 1995 - 2021, genre: "Web Design", nationality: "American", bio: "I like coding. It is challenging."})
    return arr;
  };
